...
snakemake <- Snakemake(
    input = list('output/seed_48_sep/1_feature_selection/seed_48_sep.counts.train.VST.tsv', 'output/seed_48_sep/1_feature_selection/seed_48_sep.counts.test.VST.tsv', 'output/seed_48_sep/1_feature_selection/seed_48_sep.counts.val.VST.tsv', 'input/seed_48_sep/seed_48_sep.metadata.train.tsv', 'input/seed_48_sep/seed_48_sep.metadata.test.tsv', 'input/seed_48_sep/seed_48_sep.metadata.val.tsv', 'output/seed_48_sep/1_feature_selection/seed_48_sep.deseqResults.tsv', "counts_train_vst" = 'output/seed_48_sep/1_feature_selection/seed_48_sep.counts.train.VST.tsv', "counts_test_vst" = 'output/seed_48_sep/1_feature_selection/seed_48_sep.counts.test.VST.tsv', "counts_val_vst" = 'output/seed_48_sep/1_feature_selection/seed_48_sep.counts.val.VST.tsv', "meta_train" = 'input/seed_48_sep/seed_48_sep.metadata.train.tsv', "meta_test" = 'input/seed_48_sep/seed_48_sep.metadata.test.tsv', "meta_val" = 'input/seed_48_sep/seed_48_sep.metadata.val.tsv', "deseq_results" = 'output/seed_48_sep/1_feature_selection/seed_48_sep.deseqResults.tsv'),
    output = list('output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.rds', 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.train.txt', 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.test.txt', 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.val.txt', "rds_output" = 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.rds', "train_stats" = 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.train.txt', "test_stats" = 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.test.txt', "val_stats" = 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES.val.txt'),
    params = list('output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES', 'tb', './workflow/scripts/func2_train-models.r', 'EXTRATREES', 'positive', 'negative', "output_prefix" = 'output/seed_48_sep/EXTRATREES/seed_48_sep.EXTRATREES', "group_column" = 'tb', "model_functions" = './workflow/scripts/func2_train-models.r', "model" = 'EXTRATREES', "group1_name" = 'positive', "group2_name" = 'negative'),
    wildcards = list('seed_48_sep', 'EXTRATREES', "sample" = 'seed_48_sep', "model" = 'EXTRATREES'),
    threads = 1,
    log = list(),
