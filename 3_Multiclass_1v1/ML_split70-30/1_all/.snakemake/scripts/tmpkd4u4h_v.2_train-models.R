...
snakemake <- Snakemake(
    input = list('output/seed_17_sep/1_feature_selection/seed_17_sep.counts.train.VST.tsv', 'output/seed_17_sep/1_feature_selection/seed_17_sep.counts.test.VST.tsv', 'output/seed_17_sep/1_feature_selection/seed_17_sep.counts.val.VST.tsv', 'input/seed_17_sep/seed_17_sep.metadata.train.tsv', 'input/seed_17_sep/seed_17_sep.metadata.test.tsv', 'input/seed_17_sep/seed_17_sep.metadata.val.tsv', 'output/seed_17_sep/1_feature_selection/seed_17_sep.deseqResults.tsv', "counts_train_vst" = 'output/seed_17_sep/1_feature_selection/seed_17_sep.counts.train.VST.tsv', "counts_test_vst" = 'output/seed_17_sep/1_feature_selection/seed_17_sep.counts.test.VST.tsv', "counts_val_vst" = 'output/seed_17_sep/1_feature_selection/seed_17_sep.counts.val.VST.tsv', "meta_train" = 'input/seed_17_sep/seed_17_sep.metadata.train.tsv', "meta_test" = 'input/seed_17_sep/seed_17_sep.metadata.test.tsv', "meta_val" = 'input/seed_17_sep/seed_17_sep.metadata.val.tsv', "deseq_results" = 'output/seed_17_sep/1_feature_selection/seed_17_sep.deseqResults.tsv'),
    output = list('output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.rds', 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.train.txt', 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.test.txt', 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.val.txt', "rds_output" = 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.rds', "train_stats" = 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.train.txt', "test_stats" = 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.test.txt', "val_stats" = 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES.val.txt'),
    params = list('output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES', 'tb', './workflow/scripts/func2_train-models.r', 'EXTRATREES', 'positive', 'negative', "output_prefix" = 'output/seed_17_sep/EXTRATREES/seed_17_sep.EXTRATREES', "group_column" = 'tb', "model_functions" = './workflow/scripts/func2_train-models.r', "model" = 'EXTRATREES', "group1_name" = 'positive', "group2_name" = 'negative'),
    wildcards = list('seed_17_sep', 'EXTRATREES', "sample" = 'seed_17_sep', "model" = 'EXTRATREES'),
    threads = 1,
    log = list(),
